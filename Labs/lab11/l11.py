...
if mode == "Insert":
    ...
    if inmode == "Console":
        while True:
            ...
            cur.execute("""INSERT INTO phonebook (number, name, second_name) VALUES (%s, %s, %s);""",
                        (number, name, second_name))
            conn.commit()
        ...
        def insList(users):
            for user in users:
                ...
                cur.execute("INSERT INTO phonebook (name, second_name, number) VALUES (%s, %s, %s);",
